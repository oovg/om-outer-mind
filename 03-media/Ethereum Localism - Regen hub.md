---
title: "Ethereum Localism — 17: Regen Hub"
status: completed
created: 2026-03-04
updated: 2026-03-04
author:
  - Benjamin Life
  - Owocki
description: Benjamin Life and Kevin Owocki describe the Regen Hub as a civic utility and commons architecture — a community-owned co-working and gathering space that uses decentralized coordination and co-working membership to provide value without extracting profit. Presents a step-by-step playbook (trust building, space procurement, governance and roles, vibes and programming, conflict resolution, iteration) informed by six months of operating RegenHub Boulder, where weekly 4:20pm happy hours became a schelling point for the local impact tech scene. Situates the model as an open protocol for community-led third spaces, with emergent benefits including free event space, friendship, civic tech infrastructure, collaborative braintrust, scenius, and federated network effects.
tags:
