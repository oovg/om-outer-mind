...
author:
  - exeunt
  - Ven Gist
description: "A philosophical-poetic 'network incantation' by Exeunt and Ven Gist arguing that Control Organizations — from nation-states to corporations — sustain themselves through a mystical 'ban': an Emanationist metaphysics that conceals the relational source of all power and forecloses access to the Exterior. Introduces 'substrates' (permissionless, shifting memetic communities that animate and check organizations from outside) as the key anti-capture mechanism latent but undertheorized in the DAO space. Proposes a design horizon of metastability — organizations that are neither pure substrate nor pure institution, superposed and potent with both capacities — and argues the revolutionary act is not choosing the right form, but illuminating the exit. Draws on Deleuze & Guattari, Pynchon, Bruno Latour, and Gilbert Simondon."
tags:
  - output/essay
ai-ready: true
---
...
mystical Emanationist philosophy, **_[[glossary/Control]]_**.
